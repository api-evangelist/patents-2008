...
title: Method of printing a compressed image having a bi-level black layer and a contone layer
...
url: http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&p=1&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=1&f=G&l=50&d=PALL&S1=07936478&OS=07936478&RS=07936478
...
---
This is a Continuation of Ser. No. 11 592 985 filed Nov. 6 2006 which is a Continuation of Ser. No. 10 975 407 filed Oct. 29 2004 now issued U.S. Pat. No. 7 164 501 which is a Continuation of Ser. No. 10 636 268 filed Aug. 8 2003 now issued U.S. Pat. No. 7 136 195 which is a Divisional of Ser. No. 09 436 747 filed Nov. 9 1999 now issued U.S. Pat. No. 6 687 022 all of which is herein incorporated by reference.
...
In one broad form the invention comprises a capping mechanism for use with a printer assembly in which a print head discharges dots of ink to form an image comprising 

a drive unit adapted to move said elastomeric seal between a first position in which said elastomeric seal seals said printhead in an air tight manner during non printing modes of the printer assembly and a second positioning in which the elastomeric seal is positioned away from said printhead during printing modes of the printer to allow paper to pass through said printer assembly and to allow said print head to print on said paper.
...
Note that the algorithm is blind to actual edge continuity between lines and may in tact match the wrong edges between two lines. Happily the compression format has nothing to say about this since it decodes correctly and it is difficult for a wrong match to have a detrimental effect on the compression ratio.
