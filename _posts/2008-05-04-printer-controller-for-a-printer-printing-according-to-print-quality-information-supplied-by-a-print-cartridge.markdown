...
---
The present application is a continuation of U.S. application Ser. No. 11 706 297 filed on Feb. 15 2007 which is a continuation of U.S. application Ser. No. 11 231 856 filed Sep. 22 2005 now issued U.S. Pat. No. 7 196 820 which is a continuation of U.S. application Ser. No. 10 659 013 filed on Sep. 11 2003 now issued as U.S. Pat. No. 7 027 177 which is a continuation of U.S. application Ser. No. 09 436 909 filed on Nov. 9 1999 now issued as U.S. Pat. No. 6 665 094 the entire contents of which are herein incorporated by reference.

This invention concerns a digital printing system including a personal computer and a printer driver for a high performance color printer such as a printer using a page width color inkjet printhead.

The invention is a digital printing system that includes a personal computer and a printer. The computer includes a printer driver that receives and compresses print data. The printer is connected to the personal computer and includes a data expansion system and a page width color inkjet printhead. A transmission system is connected to both the personal computer and to the printer for transmitting the compressed print data from the personal computer to the data expansion system of the printer.

The printer driver may manage a two layer buffer where the first layer of the buffer contains background contone data and the second layer of the buffer contains foreground bi level pixel data.

The system may composite a black image object with the bi level second layer of the buffer and composite a contone color image object with the contone first layer of the buffer. Wherever a contone color image object obscures the bi level second layer the obscured bi level second layer pixel data may be composited with the contone first layer and removed from the bi level second layer before a contone color image object is composited with the contone first layer.

The compressed print data may include data from a page where the data expansion system expands the compressed print data as the page is being printed.

The data expansion system may decompress 267 ppi contone CMYK image data halftone resulting contone pixels to 1600 dpi bi level CMYK dots decompress 800 dpi bi level black text data and composite resulting bi level black text dots over the corresponding bi level CMYK image dots.

The page width color inkjet printhead may be an 8 page width drop on demand microelectromechanical inkjet Memjet printhead.
