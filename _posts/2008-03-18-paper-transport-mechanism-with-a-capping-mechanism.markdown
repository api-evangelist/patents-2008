...
---
The present application is a continuation of U.S. application Ser. No. 11 730 387 filed on Apr. 2 2007 now issued U.S. Pat. No. 7 365 874 which is a continuation of U.S. application Ser. No. 10 636 218 filed on Aug. 8 2003 now issued as U.S. Pat. No. 7 215 443 which is a divisional of U.S. application Ser. No. 09 436 747 filed on Nov. 9 1999 now issued as U.S. Pat. No. 6 687 022 all of which are herein incorporated by reference.
...
In one broad form the invention comprises a method of printing using a PC having a low speed universal serial bus and a microelectromechanical inkjet printer in communication with said PC via the low speed universal serial bus wherein the microelectromechanical inkjet printer reproduces black text and graphics directly using bi level black and reproducing contone images and graphics using dithered bi level CMYK comprising the steps of 

compressing using the PC the rendered contone images and graphics data and the rendered black text and graphics data separately with the total resultant data being 3 MB page 

decompressing and dithering the transmitted compressed contone images and graphics data to bi level CMYK 

In another form the invention comprises a combination of a PC and a microelectromechanical inkjet printer in communication with said PC wherein 

a low speed universal serial bus is located on said PC and is in communication with said microelectromechanical inkjet printer 

a contone image and graphics render unit located in said PC to render said contone image and graphics to a pixel level 

a black text and graphics render unit located in said PC to render said black text and graphics to a dot level 

a second compression unit in said PC to compress said rendered black text and graphics whereby said resultant data for both compressions is 3 MB page 

a processing unit to transmit said compressed data to said printer via the low speed universal serial bus to said printer 

a decompressing and dither unit in said render unit to decompress and dither said rendered contone image and graphics data 

a decompression unit in said render unit to decompress said compressed and rendered black text and graphics 

a compositor unit to combine said dithered data with foreground bi level black text and graphic data and feed said combined data to the print head for printing of the image.
...
When a contone object of color Cand opacity is composited with the contone layer the contone layer and the black layer are updated as follows C x y C x y 1 x y if x y 0 Rule 3 x y 0 if x y 0 Rule 4 x y 0 Rule 5 C x y 
